        ...
        if (splitted[0].equals("-warp")) {
            ...
            if ((victim != null)) {
                if (splitted.length == 2) {
                    ...
                    GameMap target = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(Integer.parseInt(splitted[2]));
                    victim.changeMap(target, target.getPortal(0));
                }
            } else {
                try {
                    victim = c.getPlayer();
                    int victimWorld = cserv.getPlayerStorage().getCharacterByName(splitted[1]).getWorldId();
                    ...
                    if (c.getChannelServer().getWorldInterface().getLocation(splitted[1]) ==
                        ...
                        c.getPlayer().sendNotice(6, "Please make sure that you are on the same channel as the user.");
                    }
                } catch (Exception e) {
                    c.getPlayer().sendNotice(6, "Something went wrong " +
                            e.getMessage());
                }
            }
            ...
            victim = cserv.getPlayerStorage().getCharacterByName(splitted[1]);
            for (int i = 1; i <= 10; i++) {
                GameMap target = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(200000000);
                Portal targetPortal = target.getPortal(0);
                victim.changeMap(target, targetPortal);
                GameMap target1 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(102000000);
                Portal targetPortal1 = target.getPortal(0);
                victim.changeMap(target1, targetPortal1);
                GameMap target2 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(103000000);
                Portal targetPortal2 = target.getPortal(0);
                victim.changeMap(target2, targetPortal2);
                GameMap target3 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(100000000);
                Portal targetPortal3 = target.getPortal(0);
                victim.changeMap(target3, targetPortal3);
                GameMap target4 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(200000000);
                Portal targetPortal4 = target.getPortal(0);
                victim.changeMap(target4, targetPortal4);
                GameMap target5 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(211000000);
                Portal targetPortal5 = target.getPortal(0);
                victim.changeMap(target5, targetPortal5);
                GameMap target6 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(230000000);
                Portal targetPortal6 = target.getPortal(0);
                victim.changeMap(target6, targetPortal6);
                GameMap target7 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(222000000);
                Portal targetPortal7 = target.getPortal(0);
                victim.changeMap(target7, targetPortal7);
                GameMap target8 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(251000000);
                Portal targetPortal8 = target.getPortal(0);
                victim.changeMap(target8, targetPortal8);
                GameMap target9 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(220000000);
                Portal targetPortal9 = target.getPortal(0);
                victim.changeMap(target9, targetPortal9);
                GameMap target10 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(221000000);
                Portal targetPortal10 = target.getPortal(0);
                victim.changeMap(target10, targetPortal10);
                GameMap target11 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(240000000);
                Portal targetPortal11 = target.getPortal(0);
                victim.changeMap(target11, targetPortal11);
                GameMap target12 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(600000000);
                Portal targetPortal12 = target.getPortal(0);
                victim.changeMap(target12, targetPortal12);
                GameMap target13 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(800000000);
                Portal targetPortal13 = target.getPortal(0);
                victim.changeMap(target13, targetPortal13);
                GameMap target14 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(680000000);
                Portal targetPortal14 = target.getPortal(0);
                victim.changeMap(target14, targetPortal14);
                GameMap target15 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(105040300);
                Portal targetPortal15 = target.getPortal(0);
                victim.changeMap(target15, targetPortal15);
                GameMap target16 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(990000000);
                Portal targetPortal16 = target.getPortal(0);
                victim.changeMap(target16, targetPortal16);
                GameMap target17 = ChannelManager.getInstance(c.getChannelId()).getMapFactory(c.getWorldId()).getMap(100000001);
            ...
            if (splitted.length != 2) {
                c.getPlayer().sendNotice(6, "Syntax: !lolcastle level (level = 1-5)");
            }
            ...
            if (splitted.length > 2) {
                try {
                    ...
                    c.getPlayer().sendNotice(5, "Invalid portal selected.");
                } catch (NumberFormatException a) {
                    c.getPlayer().sendNotice(5, "Invalid map id.");
                }
            }
