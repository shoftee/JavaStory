...
public class SkillFactory {
    ...
    private final static MapleData stringData = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("org.javastory.wzpath") + "/String.wz")).getData("Skill.img");
    ...
    public static final ISkill getSkill(final int id) {
        ...
        final MapleDataProvider datasource = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("org.javastory.wzpath") + "/Skill.wz"));
