...
//	    }
    ...
    public void resetStats(final int str, final int dex, final int int_, final int luk) {
        List<Pair<Stat, Integer>> newStats = Lists.newArrayList();
        ...
        newStats.add(new Pair<Stat, Integer>(Stat.STR, str));
        newStats.add(new Pair<Stat, Integer>(Stat.DEX, dex));
        newStats.add(new Pair<Stat, Integer>(Stat.INT, int_));
        newStats.add(new Pair<Stat, Integer>(Stat.LUK, luk));
        newStats.add(new Pair<Stat, Integer>(Stat.AVAILABLE_AP, total));
