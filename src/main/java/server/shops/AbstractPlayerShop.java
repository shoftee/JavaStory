...
public abstract class AbstractPlayerShop extends AbstractGameMapObject implements PlayerShop {
    ...
    protected WeakReference<ChannelCharacter>[] visitors = new WeakReference<>[3];
    ...
    public void removeVisitors() {
        ChannelCharacter chr = visitors[0].get();
        if (chr != null) {
            removeVisitor(chr);
        }
        chr = visitors[1].get();
    ...
    public void addVisitor(ChannelCharacter visitor) {
        ...
        if (i > -1) {
            ...
            visitors[i - 1] = new WeakReference(visitor);
    ...
    public void removeVisitor(ChannelCharacter visitor) {
        ...
        if (slot != -1) {
            ...
            visitors[slot - 1] = new WeakReference(null);
