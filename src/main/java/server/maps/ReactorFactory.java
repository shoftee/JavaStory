...
public class ReactorFactory {
    ...
    private static final WzDataProvider data = WzDataProviderFactory.getDataProvider(new File(System.getProperty("org.javastory.wzpath") + "/Reactor.wz"));
    private static Map<Integer, ReactorStats> reactorStats = new HashMap<Integer, ReactorStats>();
	...
	if (stats == null) {
		...
		if (reactorInfoData != null) {
			...
			if (type == 100) { //reactor waits for item
			    reactItem = new Pair<Integer, Integer>(WzDataTool.getIntConvert("0", reactorInfoData), WzDataTool.getIntConvert("1", reactorInfoData));
