...
public class PlayerShopPacket {
    ...
    public static final GamePacket sendTitleBox() {
	final PacketBuilder builder = new PacketBuilder();
...
builder.writeAsShort(ips.getVisitorSlot(chr));
    ...
    public static final GamePacket shopChat(final String message, final int slot) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket shopErrorMessage(final int error, final int type) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket destroyHiredMerchant(final int id) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket shopVisitorLeave(final byte slot) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket Merchant_Buy_Error(final byte message) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket merchItem_Message(final byte op) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket merchItemStore(final byte op) {
	final PacketBuilder builder = new PacketBuilder();
    ...
    public static final GamePacket merchItemStore_ItemData(final MerchItemPackage pack) {
	final PacketBuilder builder = new PacketBuilder();
