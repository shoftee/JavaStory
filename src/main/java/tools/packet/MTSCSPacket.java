...
public class MTSCSPacket {
	...
	public static GamePacket warpCS(MapleClient c) {
	...
	public static GamePacket changePetName(MapleCharacter chr, String newname, int slot) {
		PacketBuilder builder = new PacketBuilder();
	...
	public static GamePacket getTrockRefresh(MapleCharacter chr, boolean vip, boolean delete) {
		PacketBuilder builder = new PacketBuilder();
	...
	public static GamePacket sendWishList(MapleCharacter chr, boolean update) {
		PacketBuilder builder = new PacketBuilder();
	...
	public static GamePacket showNXMapleTokens(MapleCharacter chr) {
		PacketBuilder builder = new PacketBuilder();
	...
	public static GamePacket showBoughtCSItem(int itemid , int accountId) {
		...
		builder.writeLong(137235);//HexTool.getByteArrayFromHexString("13 18 02 00 00 00 00 00")); // uniq id
		builder.writeLong(accountId);
		builder.writeInt(itemid);
		builder.writeBytes(HexTool.getByteArrayFromHexString("03 D1 CC 01")); // probably SN
		builder.writeAsShort(1); // quantity
		builder.writeZeroBytes(14);
	...
	public static GamePacket showBoughtCSQuestItem(short position, int itemid) {
		...
		builder.writeBytes(HexTool.getByteArrayFromHexString("01 00 00 00 01 00")); // probably ID and something else
