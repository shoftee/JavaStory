...
public final class QuestInfoProvider {
    ...
    private static QuestInfo loadQuest(int questId) {
        ...
        quest.autoPreComplete = WzDataTool.getInt("autoPreComplete", questInfo, 0) ==
                1;
    ...
    public static class QuestInfo {
        ...
        public void complete(ChannelCharacter c, int npcId, Integer selection) {
            if ((autoPreComplete || checkNpcOnMap(c, npcId)) &&
                    canComplete(c, npcId)) {
                ...
                // Quest completion
                c.getClient().write(MaplePacketCreator.showSpecialEffect(9));
