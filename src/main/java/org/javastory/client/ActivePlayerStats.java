...
//	}
        ...
        if (mount != null) {
            ...
            switch (mount.intValue()) {
                ...
                case 3:
                    ...
                    break;
                default:
                    System.err.println("Unhandeled monster riding level, Speedmod = " +
                            speedMod + "");
            }
        }
        ...
        if (watk == 0) {
            ...
            if (weapon_item != null) {
                ...
                switch (weapon) {
                    ...
                    case CLAW:
                    case DAGGER:
                        if ((job >= 400 && job <= 422) || (job >= 1400 && job <=
                                1412)) {
                            primary = localLUK;
                    ...
                    case GUN:
                        ...
                        break;
                    case NOT_A_WEAPON:
                        if ((job >= 500 && job <= 522) || (job >= 1500 && job <=
                                1512)) {
                            primary = localSTR;
                            secondary = localDEX;
                        } else {
                ...
                maxBaseDamage = ((weapon.getMaxDamageMultiplier() * primary) +
                        secondary) * watk / 100;
            } else {
                maxBaseDamage = 0;
            }
    ...
    public final void relocHeal() {
        ...
        if (Jobs.isJobFamily(200, jobId)) {
            ...
            shouldHealMP += ((float) ((float) chra.getCurrentSkillLevel(SkillFactory.getSkill(2000000)) /
                    10) * chra.getLevel());
