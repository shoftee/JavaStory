...
public class AesTransform {
     ...
     * @param versionType   the version representation type
     * 
     ...
     * 
     * @param data  the array to transform
     * @param iv    the initialization vector to use for the transformation.
     ...
     * 
     * @param data  the packet byte array, including header
