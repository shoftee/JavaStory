...
public class GameConstants {
	...
	public static boolean isCrossbowArrow(final int itemId) {
		return itemId >= 2061000 && itemId < 2062000;
	}

	public static boolean isBowArrow(final int itemId) {
	...
	public static boolean isUseableItem(final int id) {
