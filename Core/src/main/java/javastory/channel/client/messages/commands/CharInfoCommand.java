...
public class CharInfoCommand implements Command {
	...
	public void execute(ChannelClient c, String[] splittedLine)
		...
		final ChannelCharacter other = c.getChannelServer().getPlayerStorage()
				.getCharacterByName(splittedLine[1]);
		...
		builder.append(other.getMap().getFootholds()
	...
	public CommandDefinition[] getDefinition() {
		return new CommandDefinition[] {
			new CommandDefinition(
									"charinfo",
									"charname",
									"Shows info about the charcter with the given name",
									2)
		};
	}
}