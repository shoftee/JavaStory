...
public class Skill implements ISkill {
	...
	public static final int[] DUALBLADE_SKILLS = new int[] { 4311003, 4321000, 4331002, 4331005, 4341004, 4341007 };
	//
	public static final int[] EVAN_SKILLS_1 = new int[] { 22171000, 22171002, 22171003, 22171004 };
	//
