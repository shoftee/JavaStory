...
public enum CheatingOffense {
	...
	FASTATTACK((byte) 5, 6000, 10, (byte) 2),
	FASTATTACK2((byte) 5, 9000, 15, (byte) 2),
	...
	HIGH_DAMAGE_2((byte) 7, 30000),
	HIGH_DAMAGE_3((byte) 10, 30000),
	...
	ITEMVAC_CLIENT((byte) 5, 10000, 5),
	ITEMVAC_SERVER((byte) 3, 30000, 70),
	PET_ITEMVAC_CLIENT((byte) 5, 10000, 10),
	PET_ITEMVAC_SERVER((byte) 3, 30000, 100),
	USING_FARAWAY_PORTAL((byte) 1, 60000, 100, (byte) 0),
	FAST_TAKE_DAMAGE((byte) 1, 60000, 100),
	HIGH_AVOID((byte) 20, 180000, 6),
	...
	FAMING_SELF((byte) 1, 300000), // purely for marker reasons (appears in the
									// database)
	...
	private CheatingOffense(final byte points, final long validityDuration,
			final int autobancount, final byte bantype) {
		this.points = points;
