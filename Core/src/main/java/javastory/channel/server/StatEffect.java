...
//	    addBuffStatPairToListIfNotZero(statups, BuffStat.EXPRATE, Integer.valueOf(2)); // EXP
		...
		if (skill) { // hack because we can't get from the datafile...
			...
			case 4321000: //tornado spin uses same buffstats
				ret.duration = 1000;
				statups.add(new BuffStatValue(BuffStat.DASH_SPEED, 100 + ret.x));
			...
			case 1311008: // dragon blood
				...
				break;
			case 4341007:
				statups.add(new BuffStatValue(BuffStat.THORNS, ret.x << 8 | ret.y));
				break;
			case 4341002:
			...
			case 3221002: // sharp eyes marksmen
				statups.add(new BuffStatValue(BuffStat.SHARP_EYES, ret.x << 8 | ret.y));
				break;
