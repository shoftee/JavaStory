...
public class AttackInfo {
	...
	public byte hits, targets, tbyte, display, animation, speed, csstar, AOE,
			slot;

	public final StatEffect getAttackEffect(final ChannelCharacter chr,
			int skillLevel, final ISkill skill_) {
