...
public class MTSCSPacket {
	...
	public static GamePacket changePetName(ChannelCharacter chr,
			String newname, int slot) {
		PacketBuilder builder = new PacketBuilder();
	...
	public static GamePacket getTrockRefresh(ChannelCharacter chr, boolean vip,
			boolean delete) {
		PacketBuilder builder = new PacketBuilder();
	...
	public static GamePacket showBoughtCSQuestItem(short position, int itemid) {
		...
		builder.writeBytes(HexTool
				.getByteArrayFromHexString("01 00 00 00 01 00")); // probably ID
																	// and
																	// something
																	// else
	...
	public static GamePacket enableUse1() {
		...
		builder.writeAsShort(ServerPacketOpcode.CS_OPERATION.getValue());
		builder.writeBytes(HexTool
				.getByteArrayFromHexString("4E 00 00 04 00 07 00 00 00 04 00"));
