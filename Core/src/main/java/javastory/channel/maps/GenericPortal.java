...
public class GenericPortal implements Portal {
	...
	if (getScriptName() != null) {
	    ...
	    player.changeMap(to, to.getPortal(getTarget()) == null ? to.getPortal(0) : to.getPortal(getTarget())); //late resolving makes this harder but prevents us from loading the whole world at once
	}
    }
}