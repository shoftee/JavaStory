...
public interface WorldRegistry extends Remote {
    ...
    void changeRank(final int gid, final int cid, final MemberRank newRank) throws RemoteException;

    void changeRankTitle(final int gid, final String[] ranks) throws RemoteException;

    int createGuild(final int leaderId, final String name) throws RemoteException;

    Messenger createMessenger(final MessengerMember chrfor) throws RemoteException;
    ...
    void expelMember(final GuildMember initiator, final int cid) throws RemoteException;
    ...
    Collection<ChannelWorldInterface> getAllChannelServers() throws RemoteException;
    ...
    void guildChat(final int gid, final String name, final int cid, final String msg) throws RemoteException;
    ...
    void setGuildEmblem(final int gid, final short bg, final byte bgcolor, final short logo, final byte logocolor) throws RemoteException;

    void setGuildMemberOnline(final GuildMember mgc, final boolean bOnline, final int channel) throws RemoteException;

    void setGuildNotice(final int gid, final String notice) throws RemoteException;
