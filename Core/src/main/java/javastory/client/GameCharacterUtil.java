...
public class GameCharacterUtil {
	...
	private static final Pattern namePattern = Pattern
			.compile("[a-zA-Z0-9_-]{4,12}");
	private static final Pattern petPattern = Pattern
			.compile("[a-zA-Z0-9_-]{4,12}");
	...
	public static int Change_SecondPassword(final int accid,
	...
	private static boolean check_ifPasswordEquals(final String passhash,
			final String pwd, final String salt) {
