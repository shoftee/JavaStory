...
public class NpcConversationManager extends AbstractPlayerInteraction {
    ...
    public List<ChannelCharacter> getPartyMembers() {
        ...
        for (ChannelServer channel : ChannelManager.getAllInstances()) {
            for (ChannelCharacter chr : channel.getPartyMembers(getPlayer().getParty().getId())) {
    ...
    public void registerSquad(String type, int minutes, String startText) {
        ...
        final Squad squad = new Squad(super.client.getChannelId(), type, player, minutes
                * 60 * 1000);
        final GameMap map = player.getMap();

        map.broadcastMessage(MaplePacketCreator.getClock(minutes * 60));
        map.broadcastMessage(MaplePacketCreator.serverNotice(6, player.getName()
                + startText));
    ...
    public void resetStats(final int str, final int dex, final int int_, final int luk) {
        ...
        super.client.write(MaplePacketCreator.updatePlayerStats(stats, false, chr.getJobId()));
    }
    ...
    public void maxStats() {
        ...
        super.client.write(MaplePacketCreator.updatePlayerStats(statup, player.getJobId()));
    }
