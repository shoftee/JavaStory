...
public class NpcConversationManager extends AbstractPlayerInteraction {
	...
	public void sendNext(String text) {
		super.client.write(MaplePacketCreator.getNPCTalk(	npcId, (byte) 0,
															text,
															"00 01", (byte) 0));
	}
	...
	public void sendYesNo(String text) {
		super.client.write(MaplePacketCreator.getNPCTalk(	npcId, (byte) 2,
															text,
															"", (byte) 0));
	}
	...
	public void askAcceptDecline(String text) {
		super.client
				.write(MaplePacketCreator.getNPCTalk(	npcId, (byte) 0x0C,
														text,
														"", (byte) 0));
	}
	...
	public void askAcceptDeclineNoESC(String text) {
		super.client
				.write(MaplePacketCreator.getNPCTalk(	npcId, (byte) 0x0E,
														text,
														"", (byte) 0));
	}

	public void askAvatar(String text, int... args) {
		super.client.write(MaplePacketCreator
				.getNPCTalkStyle(npcId, text, args));
	}

	public void sendSimple(String text) {
		super.client.write(MaplePacketCreator.getNPCTalk(	npcId, (byte) 5,
															text,
															"", (byte) 0));
	}

	public void sendGetNumber(String text, int def, int min, int max) {
		super.client.write(MaplePacketCreator.getNPCTalkNum(npcId, text, def,
															min, max));
	}
	...
	public void showEffect(boolean broadcast, String effect) {
		if (broadcast) {
			super.client.getPlayer().getMap()
					.broadcastMessage(MaplePacketCreator.showEffect(effect));
		} else {
	...
	public void playSound(boolean broadcast, String sound) {
		if (broadcast) {
			super.client.getPlayer().getMap()
					.broadcastMessage(MaplePacketCreator.playSound(sound));
		} else {
	...
	public void registerSquad(String type, int minutes, String startText) {
		...
		map.broadcastMessage(MaplePacketCreator.serverNotice(6, player
				.getName()
				+ startText));
	...
	public void resetStats(final int str, final int dex, final int int_,
		...
		super.client
				.write(MaplePacketCreator.updatePlayerStats(stats, false, chr
						.getJobId()));
	}
	...
	public void maxStats() {
		...
		super.client.write(MaplePacketCreator.updatePlayerStats(statup, player
				.getJobId()));
	}
